              ...
              <div className="field">
                <div className="control">
                  <label className="checkbox">
                    ...
                    <span> Acepto los <a href="https://www.uma.es/secretariageneral/newsecgen/index.php?option=com_content&view=article&id=259:reglamento-de-proteccion-de-datos-de-caracter-personal-de-la-universidad-de-malaga&catid=13&Itemid=124">terminos y condiciones</a></span>
                  </label>
                </div>
              </div>
            </section>
