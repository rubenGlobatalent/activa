...
class App extends Component {
  ...
  componentDidMount() {
    ...
    this.map.on('load', () => {
      ...
      this.map.addLayer({
        ...
        filter: ['match', ['get', 'name'], ['none', ...this.state.districtFilter.selected], true, false]
      });
  ...
  componentDidUpdate() {
    // this.map.setFilter('districts', ['match', ['get', 'name'], ['none', ...this.state.districtFilter.selected], true, false]);
  }
